            ...
            switch (_scheme) {
				...
				*/
				...
				case ColorScheme.Hue_23:
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(325), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(300), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(290), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(280), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(270), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(250), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(225), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(220), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(210), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(200), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(190), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(180), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(160), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(120), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(90), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(75), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(60), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(50), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(40), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(30), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(20), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(15), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(0), 255, 255)));
					break;
				case ColorScheme.Hue2_22:
					...
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(240), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(222), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(214), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(206), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(196), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(188), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(181), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(160), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(120), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(90), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(75), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(60), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(52), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(44), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(34), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(26), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(18), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(0), 255, 255)));
					break;
				case ColorScheme.Hue3_27:
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(350), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(340), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(330), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(320), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(310), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(300), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(290), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(280), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(270), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(260), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(250), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(240), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(230), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(220), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(210), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(200), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(190), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(180), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(170), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(160), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(150), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(140), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(130), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(120), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(110), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(100), 255, 255)));
					//ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(90), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(80), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(70), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(60), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(50), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(40), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(30), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(20), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(10), 255, 255)));
					ColorSchemeDefinition.ColorValue.Add(ZedGraph.HSBColor.ToRGB(new HSBColor(deg2bin(0), 255, 255)));
					break;
