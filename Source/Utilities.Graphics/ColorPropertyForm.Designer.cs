namespace DACarter.Utilities.Graphics {
	partial class ColorPropertyForm {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			this.PlotPropertyGrid.Location = new System.Drawing.Point(0, 0);
			this.PlotPropertyGrid.Name = "PlotPropertyGrid";
			this.PlotPropertyGrid.Size = new System.Drawing.Size(328, 409);
			this.PlotPropertyGrid.TabIndex = 0;
			this.PlotPropertyGrid.Click += new System.EventHandler(this.PlotPropertyGrid_Click);
			// 
			// ColorPropertyForm
			// 
			...
			this.Name = "ColorPropertyForm";
			this.Text = "ColorScale Properties";
